...
class SignalType(Enum):
    ...
    # Question + own previous answer only, without peer information.
    SELF_REFLECTION = "self_reflection"
    # Question + own previous answer + other agents' answers.
    STANCE_ONLY = "stance_only"
    # Question + own previous answer + other agents' full reasoning.
    REASONING = "reasoning"
...
class Agent:
    ...
    def generate_debate_response(self, question: str, round_num: int, self_previous_opinion: Optional[str], other_opinions: List[Dict], signal_type: SignalType = SignalType.REASONING) -> str:
        ...
        Signal types:
        - SELF_REFLECTION: Question + own previous stance only, without peer information.
...
Please reconsider this question based on the above information.
{answer_format}"""
            signal_type_name = "Full Reasoning"
